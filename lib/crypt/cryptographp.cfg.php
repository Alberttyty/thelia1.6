...
// Le fond du cryptogramme peut-être une image  
...
$charR = $char[0];    //255 Couleur des caractères au format RGB: Red (0->255)
$charG = $char[1];    //255 Couleur des caractères au format RGB: Green (0->255)
$charB = $char[2];     //255 Couleur des caractères au format RGB: Blue (0->255)

$charcolorrnd = false;      // Choix aléatoire de la couleur.
$charcolorrndlevel = 3;    // Niveau de clarté des caractères si choix aléatoire (0->4)
                           // 0: Aucune sélection
...
$charel = 'ABCEFGHKLMNPRTWXYZ';       // Caractères autorisés

$crypteasy = false;       // Création de cryptogrammes "faciles à lire" (true/false)
                         // composés alternativement de consonnes et de voyelles.

$charelc = 'BCFGHKLMNPRTVWXZ';   // Consonnes utilisées si $crypteasy = true
$charelv = 'AEIUY';              // Voyelles utilisées si $crypteasy = true
...
$cryptformat = "gif";   // Format du fichier image généré "GIF", "PNG" ou "JPG"
