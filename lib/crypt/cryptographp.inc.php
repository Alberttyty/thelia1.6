...
if(isset($_GET['sn'])) {if (!isset($_GET[$_GET['sn']])) unset ($_GET['sn']);}
...
if(!array_key_exists('cryptcptuse',$_SESSION)) $_SESSION['cryptcptuse']=0;
...
if(!array_key_exists('crypttime',$_SESSION)) $_SESSION['crypttime']=0;
