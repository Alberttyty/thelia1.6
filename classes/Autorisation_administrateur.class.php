...
class Autorisation_administrateur extends Baseobj
{
    ...
    public $bddvars = ["id", "administrateur", "autorisation" ,"lecture", "ecriture"];
    ...
    function charger($autorisation = null, $administrateur = null)
    {
        if ($autorisation != null && $administrateur != null) {
