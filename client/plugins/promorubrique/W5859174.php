<?php
  ...
  include_once(realpath(dirname(__FILE__)) . "/../../../classes/Produit.class.php");
    ...
    var $table="promorubrique";
		var $bddvars = array("id", "id_promo", "rubriques");
    ...
    function charger($id_promo){
			return $this->getVars("select * from $this->table where id_promo=\"$id_promo\"");
		}
    ...
    function calc_remise(&$remise,$total){
      ...
      if($this->charger($promo->id)&&$promo->code!=""){
        ...
        if($remise>$total_rubriques) $remise=$total_rubriques;
