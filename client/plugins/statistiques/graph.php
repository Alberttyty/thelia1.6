...
while($date<$date_fin){
  $values[] = ca_mois($date->format('m'),$date->format('Y'),$date->format('d'), 100, 1);
  $days[] = $date->format('j');
...
$plot->hideLine(TRUE);
$plot->setFillColor(new archiColor(150, 150, 150, 50));
