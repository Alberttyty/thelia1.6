...
class sellsyConnect_curl {
	...
	private function __construct() {
		...
		$variable->charger("sellsy-user_token");
		self::$oauth_access_token=$variable->valeur;
		$variable = new Variable();
		$variable->charger("sellsy-user_secret");
		self::$oauth_access_token_secret=$variable->valeur;
		$variable = new Variable();
		$variable->charger("sellsy-consumer_token");
		self::$oauth_consumer_key=$variable->valeur;
		$variable = new Variable();
		$variable->charger("sellsy-consumer_secret");
		self::$oauth_consumer_secret=$variable->valeur;
		$variable = new Variable();
		$variable->charger("sellsy-url_api");
		self::$api_url=$variable->valeur;
