...
$iddossier = new Dossier();
$iddossier->charger($_REQUEST['id']);
$objet = new Titlemeta();
...
<div>
    ...
    <input type="hidden" name="titlemeta_rubrique" value="0"/>
    <input type="hidden" name="titlemeta_produit" value="0"/>
    <input type="hidden" name="titlemeta_dossier" value="<?php echo $iddossier->id; ?>"/>
