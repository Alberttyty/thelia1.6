...
include_once(realpath(dirname(__FILE__)) . "/../declibre/Declibre.class.php");
include_once(realpath(dirname(__FILE__)) . "/../declibre/classes/Declibredesc.class.php");
include_once(realpath(dirname(__FILE__)) . "/../declibre/classes/Ventedeclibre.class.php");
include_once(realpath(dirname(__FILE__)) . "/../remisefidelite/Remisefidelite.class.php");
