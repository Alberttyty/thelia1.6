...
<script type="text/javascript">
	...
	function edit(){
		$(".texte_edit").editable("ajax/listedecli.php", {
		      select : true,
		      onblur: "submit",
		      cssclass : "ajaxedit",
			  width: '100%',
	...
	function suppr_declinaison() {
		return confirm("<?php echo trad("Supprimer définitivement cette déclinaison ?"); ?>");
	}
</script>
</head>
...
<ul id="Nav">
	...
	<?php lister_declinaisons('classement', 'asc'); ?>
	</div>
</div>
